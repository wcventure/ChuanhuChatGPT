...
with open(cur_path + "/../assets/custom.js", "r", encoding="utf-8") as f, open(cur_path + "/../assets/Kelpy-Codos.js", "r", encoding="utf-8") as f2, open(cur_path + "/../assets/load-mathjax.js", "r", encoding="utf-8") as f3:
    customJS = f.read()
    kelpyCodos = f2.read()
    loadMathjax = f3.read()
